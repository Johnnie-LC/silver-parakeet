...
> "Investiga cómo se manejan los Server Components en Next.js 16. Escribe tus
> hallazgos en `progress/research_server_components.md`. Tu respuesta a mí debe
> ser solo: `done -> progress/research_server_components.md` o un mensaje de bloqueo."
