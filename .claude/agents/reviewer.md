...
3. Para cada archivo modificado:
   - ¿Respeta `docs/architecture.md`? (capas, estructura de componentes)
   - ¿Respeta `docs/conventions.md`? (estilo, nombres, imports)
...
- C1: [x]
- C2: [x]
- C3: [ ]  ← Razón: usa "use client" sin necesidad
- C4: [x]
- C5: [x]

## Cambios requeridos (si aplica)
1. Eliminar `"use client"` de `src/components/products/ProductCard.tsx`.
2. ...
```
